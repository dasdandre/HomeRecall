    ...
    try {
        ...
        if (primaryColor) {
            return {
                ...
                appBarBackground: getVal('--app-header-background-color') || getVal('--primary-background-color') || defaults.appBarBackground,
                appBarText: getVal('--app-header-text-color') || getVal('--primary-text-color') || defaults.appBarText,
